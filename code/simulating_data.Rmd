...
An alternative is calculate the result of the integral and use the lower incomplete function, but it needs $-gamma_3*U2[i]*u > 0$:
...
Replacing the uniroot function with the optim, the code work (the solution found minimizes the error between $|S_i - V_i|$ and may not be a root):
